...
global $post;
$property_size       = get_post_meta( get_the_ID(), 'woo_auction_property_size', true );
$size_postfix        = get_post_meta( get_the_ID(), 'woo_auction_property_size_postfix', true );
$lot_size            = get_post_meta( get_the_ID(), 'woo_auction_property_lot_size', true );
$lot_size_postfix    = get_post_meta( get_the_ID(), 'woo_auction_property_lot_size_postfix', true );
$property_bedrooms   = get_post_meta( get_the_ID(), 'woo_auction_property_bedrooms', true );
$property_bathrooms  = get_post_meta( get_the_ID(), 'woo_auction_property_bathrooms', true );
$property_garage     = get_post_meta( get_the_ID(), 'woo_auction_property_garage', true );
$property_year_built = get_post_meta( get_the_ID(), 'woo_auction_property_year_built', true );

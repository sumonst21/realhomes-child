...
<p style="display: none;" class="auction-condition"><?php echo apply_filters('conditiond_text', __( 'Item condition:', 'wc_simple_auctions' ), $product); ?><span class="curent-bid"> <?php  _e($product->get_condition(),'wc_simple_auctions' )  ?></span></p>

<?php if(($product->is_closed() === FALSE ) and ($product->is_started() === TRUE )) : ?>			
		
	<div class="auction-time bid-stats" id="countdown"><?php echo apply_filters('time_text', __( 'Time left:', 'wc_simple_auctions' ), $product_id); ?> 
	...
	<div class='auction-ajax-change bid-stats' >
		...
		<?php if ($product->get_auction_sealed() != 'yes'){ ?>
		    <p class="auction-bid bid-stats"><?php echo $product->get_price_html() ?> </p>
...
<?php elseif (($product->is_closed() === FALSE ) and ($product->is_started() === FALSE )):?>
	...
	<div class="auction-time future bid-stats" id="countdown"><?php echo apply_filters('auction_starts_text', __( 'Auction starts in:', 'wc_simple_auctions' ), $product); ?> 
